                ...
                <div class="container">
                    <div class="header-navbar">
                        <div class="header-logo">
                            <a href="index.html"><img class="light-version-logo" src="{{asset('public/assets/media/logo.png')}}" alt="logo"></a>
                            <a href="index.html"><img class="dark-version-logo" src="{{asset('public/assets/media/logo.pngpng')}}" alt="logo"></a>
                            <a href="index.html"><img class="sticky-logo" src="{{asset('public/assets/media/logo.pngpng')}}" alt="logo"></a>
                        </div>
                                ...
                                <div class="d-block d-lg-none">
                                    <div class="mobile-nav-header">
                                        <div class="mobile-nav-logo">
                                            <a href="index.html">
                                                <img class="light-mode" src="{{asset('public/assets/media/logo-2.svg')}}" alt="Site Logo">
                                                <img class="dark-mode" src="{{asset('public/assets/media/logo-3.svg')}}" alt="Site Logo">
                                            </a>
                                        </div>
